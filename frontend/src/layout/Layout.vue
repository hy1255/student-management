    ...
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        <div class="nav-section">
          ...
          <router-link to="/course" class="nav-item" active-class="active">
        ...
        <div class="nav-section">
          ...
          <router-link to="/score/entry" class="nav-item" active-class="active">
            <span class="icon">✏️</span> 成绩录入
          </router-link>
          <router-link to="/score/list" class="nav-item" active-class="active">
            <span class="icon">📋</span> 成绩列表
          </router-link>
          <router-link to="/score/stats" class="nav-item" active-class="active">
